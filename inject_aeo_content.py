"""
AEO/SEO content enhancer for C-Bus and Dynalite area pages.

Injects a conversational FAQ section with real human questions & local context
into key suburb pages — so Google AI Overviews, Perplexity, and SGE can pull
direct answers from the page.

Strategy:
- Each suburb gets 4 unique Q&As (real questions people type or speak)
- Written in a first-person, story-driven voice (not robotic)
- FAQPage JSON-LD schema is added so Google can surface rich results
- Topics: What happened (problem), what we did, cost, timeframe
"""

import os
import re

BASE_URL = "https://www.sydneyautomationco.com.au"

# Pages to enhance — slug : (suburb, system, property_type, local_landmark)
TARGETS = {
    "cbus-repair-mosman.html":            ("Mosman", "C-Bus", "home", "Mosman Village"),
    "cbus-repair-double-bay.html":        ("Double Bay", "C-Bus", "apartment", "Bay Street"),
    "cbus-repair-cremorne.html":          ("Cremorne", "C-Bus", "home", "Cremorne Point"),
    "cbus-repair-paddington.html":        ("Paddington", "C-Bus", "terrace house", "Oxford Street"),
    "cbus-repair-balmain.html":           ("Balmain", "C-Bus", "home", "Darling Street"),
    "cbus-repair-manly.html":             ("Manly", "C-Bus", "home", "The Corso"),
    "cbus-repair-surry-hills.html":       ("Surry Hills", "C-Bus", "apartment", "Crown Street"),
    "cbus-repair-newtown.html":           ("Newtown", "C-Bus", "terrace house", "King Street"),
    "cbus-repair-pyrmont.html":           ("Pyrmont", "C-Bus", "apartment", "Darling Harbour"),
    "cbus-repair-sydney-cbd.html":        ("Sydney CBD", "C-Bus", "commercial office", "the CBD"),
    "dynalite-programmer-mosman.html":    ("Mosman", "Dynalite", "home", "Mosman Village"),
    "dynalite-programmer-double-bay.html":("Double Bay", "Dynalite", "apartment", "Bay Street"),
    "dynalite-programmer-rose-bay.html":  ("Rose Bay", "Dynalite", "home", "New South Head Road"),
    "dynalite-programmer-vaucluse.html":  ("Vaucluse", "Dynalite", "waterfront home", "Parsley Bay"),
    "dynalite-programmer-cremorne.html":  ("Cremorne", "Dynalite", "home", "Military Road"),
    "dynalite-programmer-kirribilli.html":("Kirribilli", "Dynalite", "apartment", "the harbour foreshore"),
    "dynalite-programmer-neutral-bay.html":("Neutral Bay", "Dynalite", "home", "Military Road"),
    "dynalite-programmer-st-ives.html":   ("St Ives", "Dynalite", "home", "Mona Vale Road"),
    "dynalite-programmer-turramurra.html":("Turramurra", "Dynalite", "home", "Pacific Highway"),
    "dynalite-programmer-pymble.html":    ("Pymble", "Dynalite", "home", "Pymble station"),
}

def make_faq_html(suburb, system, prop_type, landmark):
    s = system
    sl = system.lower()
    return f"""
      ...
      <div itemscope itemprop="mainEntity" itemtype="https://schema.org/Question"
        ...
        <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
          <p itemprop="text" style="color:#c8d8ec;line-height:1.75;font-size:0.95rem;">
            ...
            When we arrive at a {prop_type} near {landmark}, the first thing we do is plug in the {s} toolkit and read the
      ...
      <div itemscope itemprop="mainEntity" itemtype="https://schema.org/Question"
        ...
        <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
          <p itemprop="text" style="color:#c8d8ec;line-height:1.75;font-size:0.95rem;">
            ...
            to be commissioned — plan for 2–3 hours at your {prop_type}. Fault-finding jobs, especially in older
      ...
      <div itemscope itemprop="mainEntity" itemtype="https://schema.org/Question"
        ...
        <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
          <p itemprop="text" style="color:#c8d8ec;line-height:1.75;font-size:0.95rem;">
            ...
            We cover {suburb} and surrounding areas including {landmark} for emergency callouts. We prioritise situations
...
def make_faq_schema(suburb, system, prop_type):
    sl = system.lower()
    return f"""
  ...
  {{
    ...
    "mainEntity": [
      ...
      {{
        ...
        "acceptedAnswer": {{
          "@type": "Answer",
          "text": "Reprogramming visits typically take 2–3 hours. Fault-finding in older {suburb} {prop_type}s with aged cabling can run 3–5 hours. We always give a clear estimate before starting."
        }}
      }},
      {{
        "@type": "Question",
...
def inject_into_page(filepath, suburb, system, prop_type, landmark):
    ...
    faq_html = make_faq_html(suburb, system, prop_type, landmark)
    faq_schema = make_faq_schema(suburb, system, prop_type)

    # Insert schema into <head> before </head>
    content = content.replace('</head>', faq_schema + '</head>', 1)

    # Insert FAQ section before </main> or before <footer>
    if '</main>' in content:
        content = content.replace('</main>', faq_html + '</main>', 1)
...
# Run
enhanced = 0
for filename, (suburb, system, prop_type, landmark) in TARGETS.items():
    if not os.path.exists(filename):
        print(f'MISSING: {filename}')
        continue
    result = inject_into_page(filename, suburb, system, prop_type, landmark)
    if result:
...
print(f'\nDone — {enhanced} pages enhanced with AEO conversational content.')
