...
faq_sets = {
    'c-bus-programmer-sydney.html': [
        ...
        {"q": "What is the cost of C-Bus programming in Sydney?", "a": "Our fixed-price C-Bus programming starts from $450 for residential fault finding and scheduled maintenance. Commercial and emergency dispatch works are scoped transparently on-site before any works commence. Use our interactive cost calculator on our website for an instant estimate."},
    ],
    ...
    'lighting-automation-cost-calculator-sydney.html': [
        {"q": "How much does C-Bus programming cost in Sydney?", "a": "C-Bus programming costs in Sydney range from approximately $450-$850 for residential fault finding and scheduled maintenance, to $600-$1,400+ for commercial building audits and emergency dispatch works. All pricing is fixed-price and scope-defined before works commence. Use our interactive calculator on this page for an instant estimate."},
        {"q": "How much does a Dynalite system repair cost in Sydney?", "a": "Signify Dynalite repair costs vary based on the complexity of the fault. DyNet bus power supply replacements typically range from $380-$650 including parts. Controller firmware recovery and database restoration works are scoped from $500-$950 for commercial systems. Emergency 2-hour dispatch adds a priority surcharge."},
